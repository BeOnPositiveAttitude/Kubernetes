...
Например мы можем настроить правила таким образом, чтобы весь входящий трафик перенаправлялся на одно приложение или на разные приложения в зависимости от URL