...
Каким образом страница продукты должна понимать к какой версии модуля Reviews нужно обращаться? Как один сервис будет находить другой сервис? Какие правила для траффика? Какие таймауты?
