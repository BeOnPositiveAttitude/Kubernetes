...
Теперь мы можем маршрутизировать 99% трафика на один сервис и 1% на другой. Даже если сервис Reviews v2 будет иметь три или больше pod-ов, распределение трафика все равно останется равным 99% на Version 1 и 1% на Version 2. Количество экземпляров сейчас
