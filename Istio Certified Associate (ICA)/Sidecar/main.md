...
Это значит, что любая другая нагрузка, которая будет взаимодействовать с приложением в namespace `app`, должна иметь включенный istio sidecar. Т.е. разрешено взаимодействие только по mTLS.
